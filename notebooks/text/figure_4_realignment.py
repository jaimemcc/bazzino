...
# %% [markdown]
# # Paper Figures: Figure 4 - Data Aligned to Transitions
#
# This notebook generates Figure 4 showing behavioural and dopamine (photometry) responses aligned to the transition point where animals shift from high to low appetitive behaviour
#
